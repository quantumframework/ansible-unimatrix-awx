...
def run_module():
    ...
    facts = module.params.get('facts') or module.params['state'] == 'facts'
    if not facts and not module.params.get('key'):
        module.fail_json(msg="Provide an SSH private key with the `key` parameter.")
        return
    ...
    if facts and credential is None:
        module.fail_json(msg="Resource does not exist.")
    elif facts and credential:
        pass
